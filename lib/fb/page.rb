module Fb
  ...
  private
    ...
    def post_metrics
      %i(post_engaged_users post_video_views_organic post_video_views_paid post_video_views
      post_video_view_time post_video_avg_time_watched post_impressions post_consumptions
